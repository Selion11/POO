...
public class MMatchIteratorTester {
 ...
 */
        ...
        while(it1.hasNext()) {
            MMatchElement<String> e1 = it1.next();
 ...
 * tengan los enteros pares
        ...
        MatchIterator<Integer> it2 = new MatchIterator<>(v2, n -> n % 2 == 0);//preguntar
        while(it2.hasNext()) {
            MMatchElement<Integer> e2 = it2.next();
