...
public class MultiIteratorTester {
    public static void main(String[] args) throws MultiIteratorException {
...
// Ejemplo de uso de la clase MultiIterator
        ...
        System.out.println(multiIterator2.next()); // Imprime 11 falla aca
        try {
            multiIterator2.add(new ArrayIterator<>(v2));//falla aca
