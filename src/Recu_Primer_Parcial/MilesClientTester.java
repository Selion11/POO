...
public class MilesClientTester {
        public static void main(String[] args) {
            ...
            MilesClient chuck = new MilesClient("Chuck", 4,Club.DOSMIL);
            ...
            MilesClient sarah = new MilesClient("Sarah", 2,Club.MIL);
            //Se imprime el extracto de cada mes del cliente "Sarah" para todos los meses suscriptos
            Iterator<String> sarahIt = sarah.iterator();
            for(int i = 0; i < 2; i++) {
                System.out.println(sarahIt.next());
            }
            System.out.println("##########");
            //El extracto del tercer mes de "Sarah" arroja un error pues se suscribió por 2 meses
            try {
                sarahIt.next();
            } catch (Exception ex) {
            ...
            MilesClient morgan = new MilesClient("Morgan", 6,Club.CINCOMIL);
            //Se imprime el extracto de cada mes del cliente "Morgan" para los 4 primeros meses
            ...
            System.out.println("##########");
            //Se imprime el extracto de cada mes del cliente "Morgan" para los meses 5 y 6 Por el plan
            //elegido los 5 primeros meses tendrá millas bonus
            for(int i = 5; i < 7; i ++) {
                System.out.println(morganIt.next());
            }
            System.out.println("##########");
