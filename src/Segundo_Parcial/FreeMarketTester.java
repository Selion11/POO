...
public class FreeMarketTester{
        ...
        /*Imprime en orden alfabético todos los productos del mercado que pertenezcan a la categoría Libros
        Don Quijote
        Hamlet
        ...
        /*Imprime en orden alfabético todos los productos del mercado que pertenezcan a la categoría Alimentos
        No imprime nada pues no se agregaron productos para esa categor */
        ...
        // El usuario Pablo suma: 30 puntos fijos + ($1300 * 0) puntos adicionales = 30 puntos
        ...
        // El usuario Mariana suma: 30 puntos fijos + ($1300 * 0) puntos adicionales = 30 puntos
